...
for (iteration in 1:nrow(households)){
  ...
  for (rowNum in 1:nrow(haps_village)){ #pull out household members of matching hous
...
write.csv(households, 'ama weighted share score case_child swap temporal_match.csv')
