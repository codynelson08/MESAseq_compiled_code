...
case_children = read.csv('csp_casechild_share.csv')
...
for (case_iteration in 1:nrow(households)){
  ...
  for (household_iteration in 1:nrow(households)){
    ...
    case_children[case_iteration,tablecount] = shared_count_freq
    tablecount=tablecount+1
  }
}


write.csv(case_children, 'csp share score case_child matrix.csv')
