...
case_childrenL1 = case_childrenL2 = read.csv('ama_casechild_share.csv')
...
write.csv(case_childrenL1, 'ama household L1norm casechild matrix.csv')
write.csv(case_childrenL2, 'ama household L2norm casechild matrix.csv')
##-----------------------------------
