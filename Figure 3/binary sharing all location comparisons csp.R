#Create table of csp binary sharing between locations 
...
write.csv(districts, 'share_score_all_village_comparison_2013.csv')
district_mat=read.csv("share_score_all_village_comparison_2013.csv")
