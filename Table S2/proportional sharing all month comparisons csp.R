...
write.csv(months, 'weighted_share_score_all_month_comparison.csv')

months=read.csv("csp_weighted_share_score_all_month_comparison.csv")
...
Heatmap(as.matrix(months),col = colorRamp2(c(0, 12.5, 25),c("blue", "yellow", "red")), cluster_rows=FALSE,cluster_columns=FALSE, na_col="white")
