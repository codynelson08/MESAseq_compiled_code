...
write.csv(months, 'ama share_score_all_month_comparison.csv')

months=read.csv("ama share_score_all_month_comparison.csv")
...
Heatmap(as.matrix(months),col = colorRamp2(c(0, 30, 70),c("blue", "yellow", "red")), cluster_rows=FALSE,cluster_columns=FALSE, na_col="white")
