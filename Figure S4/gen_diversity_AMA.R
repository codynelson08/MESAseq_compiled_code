##### 
#calculate Pi, PiS, PiN for ama data


load('diversity_piNS_3.RData')

##  load data. 
haps = read.csv('ama_haps_seqs_demog_merged.csv')
...
seqs2 = subseq(seqs, 3, 299)
translate(seqs2)

##  Calculate genetic diversity.
results = read.csv("ama_haps_demog_merged_nocontrols_censored.csv")
results = results [,2:184]
...
write.csv(results, 'ama_haps_demog_merged_nocontrols_pi.csv')
